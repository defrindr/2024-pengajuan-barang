...
use App\Modules\Transaksi\Requests\PengajuanBarangStore;
use App\Modules\Transaksi\Services\PengajuanMasukService;
...
class PengajuanMasukController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        return ResponseHelper::successWithData(PengajuanMasukService::fetch($perPage, $sort, $keyword, $user));
    }

    public function store(PengajuanBarangStore $request): JsonResponse
    {
        $user = auth()->user();

        try {
            $success = PengajuanMasukService::store($request->validated(), $user);
    ...
    public function destroy(int $id): JsonResponse
    {
        $user = auth()->user();
        try {
            $success = PengajuanMasukService::destroy($id, $user);
